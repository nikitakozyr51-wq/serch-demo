        ...
        <div className="flex min-w-0 flex-1 flex-col gap-6 overflow-y-auto p-7">
          ...
          <div className="flex w-full shrink-0 items-center gap-4">
            ...
            {/*
              ...
              ни в продукте, и рисовать его здесь значило бы выдумать экран.
              Поэтому действие названо и не рисует ничего: когда за кнопкой
              появится телефония, `data-action` укажет, куда её подключать.
            */}
            <Button
              variant="primary"
              size="lg"
