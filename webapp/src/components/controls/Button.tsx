  ...
  ],
  {
    variants: {
      variant: {
        ...
        /**
         * Бесплатное действие в строке выдачи: «Открыть · 0 ₽», «Позвонить».
         * Снято с компонента `w2pux` C Кнопка · 32: заливка `fg`, подпись
         * `surface` 14 весом 600.
         *
         * ═══════════════════════════════════════════════════════════════════
         * ПЕРЕПИСАНО 10.08.2026
         * ═══════════════════════════════════════════════════════════════════
         *
         * Прежнее правило гласило: «в строке кнопка тёмная, красной становится
         * на наведении». Оно было неверным. Наведение — не состояние покоя,
         * а на 166 строках выдачи в покое стоят рядом бесплатное «Открыть»
         * и платное «Раскрыть · 199 ₽». Красный от наведения означал, что
         * платное от бесплатного не отличить, пока не подведёшь мышь, —
         * то есть ровно в тот момент, когда решение уже принято.
         *
         * Теперь красный означает списание всегда и в покое (`money`),
         * а тёмный — бесплатное действие. Три уровня работают только вместе:
         * красный читается как акцент именно потому, что рядом стоит тёмный.
         */
        row: [
          "bg-fg text-surface",
          "hover:bg-fg-hover active:bg-fg-press",
        ...
        /**
         * Необратимое действие: удалить агентство, снять доступ насовсем.
         *
         * ═══════════════════════════════════════════════════════════════════
         *
         ...
         *
         * Появился вместе с окном `СОСТОЯНИЕ · Удалить агентство` (`d7JoII`),
         * где кнопка залита `#a7463e`. До него в продукте не было ни одного
         * необратимого действия с подтверждением, и вариант был бы пустым.
         */
        danger: [
