    ...
    >
      ...
      */}
      ...
      {/*
        ...
        **Красная, когда спишутся деньги.** Прежняя запись DESIGN.md гласила:
        «в списке похожих кнопка графитовая, потому что раскрытие тут
        не главное действие экрана». Отменено 10.08.2026 — цвет говорит
        не про важность, а про деньги. В этом самом списке рядом стоят
        «Раскрыть · 199 ₽» и «Открыть · 0 ₽», и различать их по важности
        нечем: важность у них одинаковая, цена разная.
      */}
      {/* Всплытие гасится: «Раскрыть · 199 ₽» и «открыть карточку» — разные
          намерения, и одно нажатие не может значить оба. */}
      <Button
        variant={paid ? "primary" : "money"}
        size="sm"
        onClick={(event) => {
