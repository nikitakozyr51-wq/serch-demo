...
type Notice = {
  ...
  onAction?: () => void
  /**
   * Сообщение уходит: последние 260 мс его жизни.
   *
 ...
 *
 * Зеркалит появление (`.motion-in`, 260 мс) и совпадает с длительностью
 ...
 * через 260 мс уходит из списка. Повторное снятие уже уходящего ничего
 * не делает — иначе крестик, нажатый дважды, ставил бы второй таймер.
 *
 * При отключённом движении сообщение снимается сразу: ждать 260 мс невидимой
