...
function CommandPalette({
   ...
   */
  /*
    Поиск по номеру телефона — кадр `rg0mY`.
  ...
  */
  ...
  const actions: PaletteItem[] = [
    ...
    { icon: Phone, label: "Начать прозвон по текущей выдаче", aside: "⇧P", to: "/call" },
    {
      ...
      // Числа обязаны совпадать с тем, что человек увидит после нажатия.
      // Просторная строка выросла с 88 до 96 сверкой 10.08.2026, и подпись,
      // обещавшая 88, врала бы ровно в том месте, ради которого пункт
      // и существует, — в предсказании результата.
      aside: dense ? "строка 96 px" : "строка 64 px",
      run: () => setDense(!dense),
    },
  ]
