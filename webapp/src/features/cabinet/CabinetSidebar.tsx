...
type NavEntry = {
   ...
   * Сохранённые поиски адреса не имеют до тех пор, пока за ними нет данных.
   */
  to?: string
}
  ...
  return (
    <Element
      ...
      className={cn(
        ...
        // заливки, значит наведение — `warm`. Активный при этом остаётся
        // различим не заливкой, а графитовой подписью весом 600.
        active ? "bg-warm text-fg" : "bg-transparent text-text-2 hover:bg-warm",
      )}
    >
      {Icon ? (
        <Icon
