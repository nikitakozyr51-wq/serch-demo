      ...
      */}
      ...
      <div className="flex w-42 shrink-0">
        {action.kind === "blocked" ? (
          ...
          <Button
            /*
              Красный означает списание — всегда и в покое, а не от наведения.
              На 166 строках выдачи бесплатное «Открыть · 0 ₽» стоит рядом
              с платным «Раскрыть · 199 ₽», и если оба тёмные, то отличить
              их можно только подведя мышь — то есть уже приняв решение.
            */
            variant={action.kind === "disclose" ? "money" : "row"}
            size="sm"
            block
            onClick={(event) => {
