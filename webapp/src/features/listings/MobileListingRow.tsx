...
function MobileListingRow({
  ...
  return (
    ...
    >
      {/*
        Верх: кадр 96 × 64 держит высоту карточки.

        Был квадрат 96 × 96 — единственный слот продукта, показывавший
        объект не в той пропорции, в какой его показывают все остальные.
        Один и тот же снимок 900 × 600 обрезался на телефоне иначе, чем
        на компьютере, и человек видел разный кусок комнаты в зависимости
        от того, с чего смотрит.

        Правило одно на весь продукт: снимок ОБЪЕКТА — всегда три к двум.
        Квадрат остаётся там, где кадр показывает не объект, а сущность:
        обложка подборки.

        Побочная выгода замера: блок «Верх» сжался с 96 до 64, и строка
        укоротилась с 204 до 172 — на телефоне это лишний объект в экране.
      */}
      <div className="flex w-full items-start gap-3">
        ...
        <div className="flex min-w-0 flex-1 flex-col gap-1.5">
          <div className="flex w-full items-center gap-2">
            ...
            {/* Цена выключена влево, а не вправо: на телефоне колонка одна,
                и правая выключка отрывала бы цену от адреса. */}
